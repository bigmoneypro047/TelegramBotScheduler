...
const NIGHT_THREADS_BY_LANG: Record<string, string[][]> = {
  English: [
    [
      "Just invited my friend for dinner tonight, told him I want to share something life-changing 🍽️",
      "That's how I started too! My friend invited me and now look at us",
      "Food and financial wisdom — best combo ever 😂",
      "Did you show him the platform? What did he say?",
      "He couldn't believe the numbers, kept asking if it was real",
      "That's always the first reaction 😂 then they see the withdrawals",
      "I remember my first withdrawal, I was shaking",
      "Now it's just routine 💰 blessings on blessings",
      "Bringing more people to the table — literally and financially 🔥",
    ],
    [
      "Taking my colleague out for dinner tomorrow, planning to introduce him to trading 🍷",
      "Smart move! Good food makes people listen better 😄",
      "I did the same thing last month, now my friend is already earning",
      "That's the beauty of this — you share the knowledge and everyone wins",
      "My friend was skeptical at first but after seeing my lifestyle he wanted in",
      "Results speak louder than words every time",
      "Exactly! When they see you paying for dinner without even checking the bill 👑",
      "Financial confidence hits different",
      "This platform gave me that confidence, forever grateful 🙏",
    ],
    [
      "Dinner with friends tonight and the conversation turned to passive income 🍽️💰",
      "I love when that happens! Everyone gets curious",
      "My friend asked me how I afford to eat out so often now",
      "Told him it's because my money works while I eat 😂",
      "That line always gets them interested",
      "Then you show them one screenshot and it's game over",
      "My friend signed up right there at the dinner table",
      "That's how you grow your team — naturally over good food",
      "Nothing beats building wealth while building friendships ✨",
    ],
    [
      "Invited my best friend for a nice dinner, he's been struggling financially 🤝",
      "That's real friendship — sharing opportunities, not just meals",
      "I was in the same situation before someone invited me and showed me this",
      "Paying it forward is what makes this community special",
      "Did he show interest?",
      "He was amazed! Already asking how to start",
      "Another life about to change 🔥",
      "This is bigger than trading, we're changing lives one dinner at a time",
      "The ripple effect of this platform is incredible 🌊",
    ],
    [
      "Hosted a small dinner party last night, 3 friends showed up 🍽️",
      "Let me guess — you talked about the platform? 😂",
      "Of course! They saw my new watch and started asking questions",
      "When your lifestyle speaks, you don't need to convince anyone",
      "Two of them want to join now, setting them up tomorrow",
      "Your team is growing! That's how it's done 💪",
      "Dinner investment: $100. New team members: priceless 😂",
      "Seriously though, this is the best way to build — genuine connections",
      "Good food, good company, good business 👑",
    ],
    [
      "My friend took me out for dinner to celebrate my success 🥂",
      "That's beautiful! What are you celebrating?",
      "Hit my biggest monthly profit ever, had to share the moment",
      "You deserve it! Hard work pays off",
      "The best part is my friend wants to learn how I did it",
      "Dinner conversations that change lives > regular dinner conversations",
      "I'm setting up a group dinner next week to onboard 5 people",
      "That's leadership right there! Building the team over good vibes",
      "This lifestyle is addictive — in the best way possible 🔥✨",
    ],
    [
      "Treating my family to dinner tonight with this week's profits 💰🍽️",
      "Family dinners hit different when you're paying from passive income",
      "My mom couldn't believe it when I told her how I earn now",
      "Parents always worry, but when they see the results they relax",
      "My dad actually wants to learn too now 😂",
      "Generational wealth starts with moments like these",
      "From struggling to treating the whole family — what a journey",
      "This platform didn't just change my finances, it changed my family's future",
      "Blessed beyond measure 🙏🔥",
    ],
  ],
  Spanish: [
    [
      "Acabo de invitar a mi amigo a cenar, quiero compartir algo que cambia vidas 🍽️",
      "¡Así empecé yo también! Mi amigo me invitó y ahora míranos",
      "Comida y sabiduría financiera — la mejor combinación 😂",
      "¿Le mostraste la plataforma? ¿Qué dijo?",
      "No podía creer los números, seguía preguntando si era real",
      "¡Esa siempre es la primera reacción! 😂 luego ven los retiros",
      "Recuerdo mi primer retiro, estaba temblando",
      "Ahora es rutina 💰 bendiciones sobre bendiciones",
      "Trayendo más gente a la mesa — literal y financieramente 🔥",
    ],
    [
      "Voy a llevar a mi colega a cenar mañana para presentarle el trading 🍷",
      "¡Buena jugada! La buena comida hace que la gente escuche mejor 😄",
      "Hice lo mismo el mes pasado, ahora mi amigo ya está ganando",
      "Esa es la belleza de esto — compartes el conocimiento y todos ganan",
      "Mi amigo era escéptico pero cuando vio mi estilo de vida quiso entrar",
      "Los resultados hablan más fuerte que las palabras",
      "¡Exacto! Cuando te ven pagando la cena sin mirar la cuenta 👑",
      "La confianza financiera se siente diferente",
      "Esta plataforma me dio esa confianza, eternamente agradecido 🙏",
    ],
    [
      "Cena con amigos esta noche y la conversación giró hacia los ingresos pasivos 🍽️💰",
      "¡Me encanta cuando eso pasa! Todos se ponen curiosos",
      "Mi amigo me preguntó cómo puedo comer afuera tan seguido ahora",
      "Le dije que es porque mi dinero trabaja mientras como 😂",
      "Esa frase siempre los engancha",
      "Luego les muestras una captura y se acabó",
      "Mi amigo se registró ahí mismo en la mesa del restaurante",
      "Así es como creces tu equipo — naturalmente con buena comida",
      "Nada supera construir riqueza mientras construyes amistades ✨",
    ],
  ],
  Indonesian: [
    [
      "Baru saja mengajak teman makan malam, mau berbagi sesuatu yang mengubah hidup 🍽️",
      "Begitu juga awal saya! Teman saya mengajak saya dan sekarang lihat kita",
      "Makanan dan kebijaksanaan finansial — kombinasi terbaik 😂",
      "Sudah tunjukkan platformnya? Apa katanya?",
      "Dia tidak percaya dengan angkanya, terus bertanya apakah ini nyata",
      "Itu selalu reaksi pertama! 😂 lalu mereka lihat penarikannya",
      "Saya ingat penarikan pertama saya, tangan saya gemetar",
      "Sekarang sudah rutin 💰 berkah terus mengalir",
      "Membawa lebih banyak orang ke meja — secara harfiah dan finansial 🔥",
    ],
    [
      "Mau ajak kolega makan malam besok, rencana perkenalkan dia ke trading 🍷",
      "Langkah cerdas! Makanan enak bikin orang lebih mau mendengar 😄",
      "Saya melakukan hal yang sama bulan lalu, sekarang teman saya sudah menghasilkan",
      "Itulah indahnya — berbagi ilmu dan semua orang menang",
      "Teman saya awalnya skeptis tapi setelah lihat gaya hidup saya dia mau ikut",
      "Hasil berbicara lebih keras dari kata-kata",
      "Tepat! Ketika mereka lihat kamu bayar makan malam tanpa cek bill 👑",
      "Kepercayaan diri finansial rasanya berbeda",
      "Platform ini memberi saya kepercayaan diri itu, selamanya bersyukur 🙏",
    ],
    [
      "Makan malam dengan teman-teman dan obrolan berubah ke pendapatan pasif 🍽️💰",
      "Saya suka kalau begitu! Semua jadi penasaran",
      "Teman saya tanya bagaimana saya bisa sering makan di luar sekarang",
      "Saya bilang karena uang saya bekerja sementara saya makan 😂",
      "Kalimat itu selalu bikin mereka tertarik",
      "Lalu tunjukkan satu screenshot dan selesai",
      "Teman saya langsung daftar di meja makan",
      "Begitulah cara membangun tim — secara natural sambil makan enak",
      "Tidak ada yang mengalahkan membangun kekayaan sambil membangun persahabatan ✨",
    ],
  ],
};
